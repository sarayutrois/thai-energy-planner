...
import { FinancialTable, RecommendationCards, SolarChartsSection, SolarControls, SolarPageShell, SolarSummary } from "../solar-page-parts";

export default async function SolarFinancePage({ searchParams }: { searchParams?: Promise<SolarSearchParams> }) {
  ...
  return (
    <SolarPageShell active="finance" queryString={queryString}>
      <SolarControls settings={settings} action="/analysis/solar/finance" savedBillContext={savedBillContext} />
