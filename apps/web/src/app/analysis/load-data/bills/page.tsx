    ...
    <main className="min-h-screen">
      <section className="mx-auto w-full max-w-7xl px-4 py-8 md:px-6 lg:py-10">
        <PageHeader
          ...
          description="เริ่มจากเดือน จำนวนหน่วยไฟ และค่าไฟรวม ระบบจะสรุปคุณภาพข้อมูลและแนะนำขั้นตอนถัดไป โดยบันทึกข้อมูลไว้ในอุปกรณ์นี้"
        />

        <AnalysisStartContextCard {...startContext} />
        <GuidedBillWorkspace
          audience={startContext.audience}
          initialBills={[]}
        />
      </section>
    </main>
