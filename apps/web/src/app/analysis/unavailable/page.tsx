...
const labels = {
  battery: "Battery",
  ecosystem: "ระบบพลังงานรวม",
  ev: "EV",
  solar_detail: "รายละเอียด Solar",
  scenario_detail: "การเปรียบเทียบแผน",
} as const;
  ...
  return (
    <main className="min-h-screen bg-background">
      <section className="mx-auto flex w-full max-w-3xl flex-col items-center px-4 py-24 text-center md:px-6">
        ...
        <h1 className="mt-3 text-3xl font-semibold">{label} กำลังปรับปรุง</h1>
        <p className="mt-4 max-w-xl leading-7 text-muted-foreground">
          ฟีเจอร์นี้กำลังปรับปรุงให้ใช้ข้อมูล Load Profile
          และอัตราค่าไฟที่ตรวจสอบได้
          ระบบจะยังไม่แสดงผลประมาณการจนกว่าข้อมูลและสมมติฐานจะพร้อม
        </p>
        <Link
