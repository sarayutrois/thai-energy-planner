...
export const metadata: Metadata = { title: "Thai Energy Planner", description: "วางแผนค่าไฟจากข้อมูลจริง ดูความพร้อมของข้อมูล เปรียบเทียบค่าไฟ และประเมิน Solar อย่างเข้าใจง่าย" };
