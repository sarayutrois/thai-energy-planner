...
export function Alert({
  ...
  const styles = {
    information: "border-information/30 bg-information/10",
    success: "border-success/30 bg-success/10",
    warning: "border-warning/35 bg-warning/10",
    danger: "border-destructive/30 bg-destructive/10",
  };
  const Icon =
    tone === "success" ? CheckCircle2 : tone === "danger" ? AlertCircle : Info;
  return (
    <section
...
export function DataConfidence({
  ...
  label: string;
  detail: string;
  tone?: "information" | "success" | "warning";
}) {
  const styles = {
    information: "border-information/30 bg-information/10",
    success: "border-success/30 bg-success/10",
  ...
  return (
    <section className={cn("rounded-lg border p-4", styles[tone])}>
