...
### 5. หน้า Battery & EV (`/analysis/battery`, `/analysis/ev`) - ทางเลือกพลังงานเพิ่มเติม

- **หน้าที่:** Battery เลือกขนาดจากเป้าหมายลดค่าไฟ สำรองไฟ หรือเก็บ Solar ส่วนเกิน; EV วางแผนการชาร์จที่บ้านจากระยะทาง เวลาจอด กำลัง charger และ Load Profile เดิม
- **จุดเด่นนำเสนอ:** ให้คำตอบที่ลงมือทำต่อได้ เช่น ขนาดและงบ Battery, ระยะสำรอง, มิเตอร์และเวลาชาร์จ EV, ค่าไฟเพิ่ม, ต้นทุนต่อระยะทาง และคำเตือนว่าต้องตรวจระบบไฟหรือข้อมูลใดก่อนลงทุน

### 6. หน้า Ecosystem (`/analysis/ecosystem`) - แผนพลังงานรวม

- **หน้าที่:** ตรวจว่าผล TOU, Solar, Battery และ EV ตรงกับ Load Profile/ชุดบิลปัจจุบันหรือไม่ แล้วจัดลำดับการทำงานจากการจัดการโหลด ไป Solar, EV และ Battery
- **หลักการรวมตัวเลข:** เลือกผลฐานที่ดีที่สุดเพียงชุดเดียวระหว่าง TOU กับ Solar, แสดง EV เป็นโหลดเพิ่ม และไม่นำผลประหยัด Battery มาบวกซ้ำจนกว่าจะมีแบบจำลอง dispatch รวม
- **ผลลัพธ์:** ค่าไฟหลังแผนโดยประมาณ กรอบงบที่ทราบ Roadmap สี่ระยะ ข้อมูลที่ยังขาด และรายงาน Ecosystem ที่บันทึกได้

### 7. หน้า Reports (`/analysis/reports`) - สรุปผล
